...
func TestObjectManager(t *testing.T) {
	...
	t.Run("Test CreateTreeObject and GetObjectInfo", func(t *testing.T) {
		...
		tree := &Tree{
			entries: []TreeEntry{
				{otype: "blob", oid: "6eb715b073c6b28e03715129e03a0d52c8e21b73", oname: "name1", codeID: "code1", codeName: "codeName1"},
				{otype: "blob", oid: "a7fdb22705a5e6145b6a8b1fa947825c5e97a51c", oname: "name2", codeID: "code2", codeName: "codeName2"},
				{otype: "tree", oid: "a7fdb33705a5e6145b6a8b1fa947825c5e97a51c", oname: "name3", codeID: "code3", codeName: "codeName3"},
			},
		}
